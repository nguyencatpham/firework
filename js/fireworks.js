...
function fade(element) {
   ...
   * new firework on touch / click
    ...
    function createFirework() {
     ...
     var snd = new Audio("music/"+filename+".mp3"); // buffers automatically when created
    snd.play();
...
makeUnselectable(document.getElementById("text"));
  /**
  ...
  function clearContext() {
    ...
    mainContext.drawImage(background,0,0,width,height);
    }
  }
